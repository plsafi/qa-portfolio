...
| --- | --- | --- | --- | --- | --- | --- |
| TC-001 | Login with valid credentials | None | Chrome/Windows 10 | 1. Open https://www.saucedemo.com/<br>2. Enter username: standard_user<br>3. Enter password: secret_sauce<br>4. Click “Login” button.<br User is successfully logged in and redirected to the products page | Pass |
